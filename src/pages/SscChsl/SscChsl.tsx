        ...
        <div className="w-full mt-5 flex flex-col items-center gap-5">
          ...
          <div className={`accordion ${accordionsOpen[0] ? "open" : ""} border rounded-lg overflow-hidden w-full`}>
            <div className="accordion-title flex justify-between items-center p-4 cursor-pointer bg-gray-200" onClick={() => toggleAccordion(0)}>
              <h2 className="text-lg font-bold text-gray-700">What is SSC CHSL?</h2>
            ...
            <div className={`accordion-content ${accordionsOpen[0] ? "" : "hidden"} p-4`}>
              <p>
                The Staff Selection Commission - Combined Higher Secondary Level (SSC CHSL) is an examination conducted to recruit staff to various posts in ministries, departments and organisations of the Government of India. It is conducted by the Staff Selection Commission for selecting staff for various Group C posts. The Staff Selection Commission was established in 1975.
              </p>
            </div>
          </div>
              ...
              <div className="w-full">
                <table className="table-auto w-full">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border px-4 py-2">SSC CHSL Tier-I Exam Date</td>
                      <td className="border px-4 py-2">May 29-June 7, 2024</td>
                    </tr>
                    <tr>
                      <td className="border px-4 py-2">SSC CHSL Tier-II & III Exam Date</td>
          ...
          <div className={`accordion ${accordionsOpen[2] ? "open" : ""} border rounded-lg overflow-hidden w-full`}>
            ...
            <div className={`accordion-content ${accordionsOpen[2] ? "" : "hidden"} p-4`}>
              <ul className="list-disc ml-5">
                ...
                <li>Must have passed 12th Standard or equivalent examination from a recognized Board or University.</li>
                <li>Age limit varies from post to post. The minimum age limit is 18 years and the maximum age limit is 27 years.</li>
