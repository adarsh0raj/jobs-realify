        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/*<!-- Menu Item IITJEE */}
              <SidebarLinkGroup
                activeCondition={pathname.includes('jee')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes('jee') && 'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
             ...
             {/*<!-- Menu Item UPSC */}
             <SidebarLinkGroup
                activeCondition={pathname.includes('exams/upsc')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="/exams/upsc"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes('exams/upsc') && 'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              {/*<!-- Menu Item SSC-CGL*/}
             <SidebarLinkGroup
                activeCondition={pathname.includes('exams/ssc-cgl')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/*<!-- Menu Item SSC CHSL */}
             <SidebarLinkGroup
                activeCondition={pathname.includes('exams/ssc-chsl')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="/exams/ssc-chsl"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes('exams/ssc-chsl') && 'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
